...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<grpc>.freeze, [">= 1.7.2", "< 2.0"])
      s.add_runtime_dependency(%q<googleapis-common-protos>.freeze, [">= 1.3.5", "< 2.0"])
      ...
      s.add_dependency(%q<grpc>.freeze, [">= 1.7.2", "< 2.0"])
      s.add_dependency(%q<googleapis-common-protos>.freeze, [">= 1.3.5", "< 2.0"])
